...
export interface ApiAttorneyAttorney extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Attorney profiles for the team page';
  ...
  attributes: {
    barAdmissions: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    legalArea: Schema.Attribute.Enumeration<
      [
        'Corporate',
        'Litigation',
        'Employment',
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['new', 'contacted', 'resolved']> &
...
export interface ApiHeroImageHeroImage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage hero section image';
...
export interface ApiJobApplicationJobApplication
  ...
  info: {
    description: 'Career applications from the website';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    link: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'/practice-areas'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service.service'
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Team members for homepage carousel';
